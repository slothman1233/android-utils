package com.cjjc.lib_widget.wid_edittext.edit_pwd;
 ...
 * 密码输入框
 */
public class WidSplitEditTextView extends AppCompatEditText{
    //密码显示模式：隐藏密码,显示圆形
    ...
    public WidSplitEditTextView(Context context) {
        this(context, null);
    }

    //这里没有写成默认的EditText属性样式android.R.attr.editTextStyle,这样会存在EditText默认的样式
    public WidSplitEditTextView(Context context, AttributeSet attrs) {
    ...
    public WidSplitEditTextView(Context context, AttributeSet attrs, int defStyleAttr) {
