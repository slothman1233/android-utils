...
package com.cjjc.lib_widget.wid_progress;
...
//    private int totalMovedLength;
    ...
    private void initData() {
        ...
        // 已完成进度条画笔的属性
        paintInit.setColor(context.getResources().getColor(R.color.color_white));
        ...
        // 大圆画笔
        paintEndBig.setColor(context.getResources().getColor(R.color.color_white));
        ...
        paintText.setColor(context.getResources().getColor(R.color.color_white));
