package cjjc.plugin.cjjcMvp.fragment
...
import cjjc.plugin.cjjcMvp.fragment.mvp.mvpFragmentKt
...
fun RecipeExecutor.mvpFragmentRecipe(
    ...
    val mvpFragment = mvpFragmentKt(mRootPackageName,mApplicationId, mFragmentPackageName.replace("/", "."), mPageName,mFragmentLayoutName)
    // 保存Fragment
    save(
        mvpFragment,
