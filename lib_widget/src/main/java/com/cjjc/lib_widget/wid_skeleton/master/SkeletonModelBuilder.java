...
public class SkeletonModelBuilder {
    ...
    private int shapeType = SkeletonModel.SHAPE_TYPE_RECT;
    private int colorBackgroundMain = SkeletonModel.DEFAULT_COLOR_BACKGROUND_MAIN;
    ...
    private long animationDuration = SkeletonModel.DEFAULT_ANIMATION_DURATION;
    private int animationDirection = SkeletonModel.ANIMATION_DIRECTION_LTR;
    private int animationNormalType = SkeletonModel.ANIMATION_TYPE_GRADIENT;
    private int animationFinishType = SkeletonModel.ANIMATION_TYPE_GRADIENT;
    ...
    private int textShapeLineNumber = SkeletonModel.DEFAULT_TEXT_SHAPE_LINE;
    private int textShapeLineLastWidth = SkeletonModel.DEFAULT_TEXT_SHAPE_LAST_LINE_WIDTH;
    private int textShapeLineHeight = SkeletonModel.DEFAULT_TEXT_SHAPE_LINE_HEIGHT;
    private int textShapeLineSpaceVertical = SkeletonModel.DEFAULT_TEXT_SHAPE_LINE_SPACE_VERTICAL;
