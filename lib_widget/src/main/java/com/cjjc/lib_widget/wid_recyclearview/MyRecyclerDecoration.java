package com.cjjc.lib_widget.wid_recyclearview;
...
public class MyRecyclerDecoration extends RecyclerView.ItemDecoration {
    ...
    public MyRecyclerDecoration setMargin(float margin) {
        this.margin = margin;
        return this;
    }

    //设置颜色
    public MyRecyclerDecoration setColor(int color) {
        mPaint.setColor(color);
        return this;
    }

    //设置分割线高度
    public MyRecyclerDecoration setDividerHeight(float height) {
