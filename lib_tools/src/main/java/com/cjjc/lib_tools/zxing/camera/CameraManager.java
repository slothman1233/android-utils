...
package com.cjjc.lib_tools.zxing.camera;
...
import com.cjjc.lib_tools.zxing.activity.ZXingLibrary;
...
public final class CameraManager {
     ...
     * @throws IOException Indicates the camera driver failed to open.
     */
    public void openDriver(SurfaceHolder holder, boolean isLandscape) {
        if (camera == null) {
            ...
            configManager.setDesiredCameraParameters(camera, isLandscape);
