...
import com.cjjc.lib_widget.wid_skeleton.master.SkeletonModel;
import com.cjjc.lib_widget.wid_skeleton.utils.CLog;
import com.cjjc.lib_widget.wid_skeleton.utils.ColorUtils;
...
public class SkeletonViewGroup extends SkeletonMaster {
    ...
    public SkeletonViewGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SkeletonViewGroup(Context context, AttributeSet attrs, @AttrRes int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public SkeletonViewGroup(Context context, AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
        ...
        if (isCanDraw) {
            ...
            if (paintGradient == null) {
                ...
                for (int i = 0; i < skeletonModelsChildren.size(); i++) {
                    ...
                    if (skeletonAttributeChild.getShapeType() == SkeletonModel.SHAPE_TYPE_RECT) {
                        // Rectangle
                    ...
                    } else if (skeletonAttributeChild.getShapeType() == SkeletonModel.SHAPE_TYPE_OVAL) {
                        // Oval
                    ...
                    } else if (skeletonAttributeChild.getShapeType() == SkeletonModel.SHAPE_TYPE_TEXT) {
                        // Text
                        ...
                        for (int j = 0; j < lineNumber; j++) {
                            ...
                            if (j == lineNumber - 1) {
                                ...
                                switch (skeletonAttributeChild.getTextShapeLineLastWidth()) {
                                    case SkeletonModel.TEXT_SHAPE_LINE_LAST_WIDTH_FULL:
                                        // No change X1 and X2
                                        break;
                                    case SkeletonModel.TEXT_SHAPE_LINE_LAST_WIDTH_THREE_QUARTERS:
                                        if (skeletonModel.getAnimationDirection() == SkeletonModel.ANIMATION_DIRECTION_RTL) {
                                            newX1 = skeletonAttributeChild.getX1() + quarterWidth;
                                        } else {
                                            newX2 = skeletonAttributeChild.getX2() - quarterWidth;
                                        }
                                        break;
                                    case SkeletonModel.TEXT_SHAPE_LINE_LAST_WIDTH_HALF:
                                        if (skeletonModel.getAnimationDirection() == SkeletonModel.ANIMATION_DIRECTION_RTL) {
                                        ...
                                        break;
                                    case SkeletonModel.TEXT_SHAPE_LINE_LAST_WIDTH_QUARTER:
                                        if (skeletonModel.getAnimationDirection() == SkeletonModel.ANIMATION_DIRECTION_RTL) {
            ...
            if (isCanDrawFinishState) {
                ...
                switch (skeletonModel.getAnimationFinishType()) {
                    case SkeletonModel.ANIMATION_TYPE_ALPHA:
                        ...
                        break;
                    case SkeletonModel.ANIMATION_TYPE_GRADIENT:
...
//                        }
    ...
    private void generatePositionGradientFromDirectionAnimation() {
        ...
        switch (skeletonModel.getAnimationDirection()) {
            case SkeletonModel.ANIMATION_DIRECTION_LTR: {
            ...
            case SkeletonModel.ANIMATION_DIRECTION_RTL: {
                float offset = getWidth() * AnimationFractionMove;
                xStartGradient = offset;
                yStartGradient = 0;
                xEndGradient = offset + getWidth();
            ...
            case SkeletonModel.ANIMATION_DIRECTION_TTB: {
            ...
            case SkeletonModel.ANIMATION_DIRECTION_BTT: {
                float offset = getHeight() * AnimationFractionMove;
                xStartGradient = 0;
                yStartGradient = offset;
                xEndGradient = 0;
        ...
        valueAnimator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationRepeat(Animator animation) {
                ...
                if (isLastLoopAnimation) {
                    ...
                    if (skeletonModel.getAnimationFinishType() == SkeletonModel.ANIMATION_TYPE_NON) {
                        setupFinishingAnimation();
                    } else {
    ...
    public void finishAnimation(FragmentActivity activity) {
