package com.cjjc.lib_widget.wid_submit_button;
...
public class SubmitButton extends View {
    ...
    public SubmitButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        text= typedArray.getString(R.styleable.SubmitButton_text);
        typedArray.recycle();
    ...
    private void init(Context context) {
        ...
        paintArc.setColor(ContextCompat.getColor(context, R.color.color_white));
        ...
        textPaint.setColor(ContextCompat.getColor(context, R.color.color_white));
