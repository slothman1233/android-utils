...
public class SkeletonConfig {
    ...
    private SkeletonSwitchListener skeletonSwitchListener;
    ...
    private void init(){
        if(skeletonSwitchListener!=null){
            skeletonSwitchListener.switchListener(skeletonIsOn);
        }
    }
    ...
    public void setSkeletonSwitchListener(SkeletonSwitchListener skeletonSwitchListener) {
        this.skeletonSwitchListener = skeletonSwitchListener;
    }
}
